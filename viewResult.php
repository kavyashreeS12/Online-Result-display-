...
<span class="labels" style="color:#C9F;">Name : <?php echo $name;?><br>USN : <?php echo $roll;?><br>Semester : <?php echo $sem;?></span>
...
<tr><td style="text-decoration:underline;color:white;" class="labels">Total : </td><td class="labels"><?php echo $b['total'];?></td></tr>
<tr><td style="text-decoration:underline;color:white;" class="labels">Percentage : </td><td class="labels"><?php echo $b['percent'];?>%</td></tr>
<tr><td style="text-decoration:underline;" class="labels">Result : </td><td style="color:#0F0;"><?php echo $b['result'];?></td></tr>
</table>
